...
% Slide 3
\begin{frame}{The Crowding Catastrophe}
\begin{columns}
\column{0.45\textwidth}
\begin{center}
\textbf{High-D Space (10D)}\\[0.3cm]
\begin{tikzpicture}[scale=1.5]
\foreach \r/\c/\l in {0.6/green/Near, 1.0/orange/Medium, 1.4/blue/Far} {
    \draw[thick, \c, densely dotted] (0,0) circle (\r);
    \foreach \angle in {0,45,...,315} {
        \fill[\c] (\angle:\r) circle (2pt);
    }
}
\node at (0,-2) {\small Three distinct distances};
\end{tikzpicture}
\end{center}

\column{0.45\textwidth}
\begin{center}
\textbf{Projected to 2D}\\[0.3cm]
\begin{tikzpicture}[scale=1.5]
\foreach \i in {1,...,8} {
    \pgfmathsetmacro\r{0.15*rnd}
    \pgfmathsetmacro\a{360*rnd}
    \fill[green] (\a:\r) circle (2pt);
    \fill[orange] (\a+10:\r+0.05) circle (2pt);
    \fill[blue] (\a-10:\r+0.03) circle (2pt);
}
\node at (0,-2) {\small\textcolor{red}{All distances collapse!}};
\end{tikzpicture}
\end{center}
\end{columns}
